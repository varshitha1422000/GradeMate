...
const Dashboard = () => {
  ...
  const renderQuestionPanel = () => {
    if (regradeStep === "egrading") {
      return (
        <div style={{ textAlign: "center", marginTop: "2rem" }}>
          <h3>Egrading...</h3>
        </div>
      );
    } else if (regradeStep === "regrading") {
      return (
        <div style={{ textAlign: "center", marginTop: "2rem" }}>
          <h3>Regrading screen...</h3>
        </div>
      );
    }
    // If "idle" or "done", just show normal content
    return (
      <>
  ...
  const renderSubQuestionPanel = () => {
    if (regradeStep === "egrading" || regradeStep === "regrading") {
      return (
